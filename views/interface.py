...
class GifThread(threading.Thread):
    def __init__(self, window, label, frameCnt, file_name):
    ...
    def run(self):
        ...
        frames = [tk.PhotoImage(file=file_path, format=f"gif -index {i}") for i in range(self.frameCnt)]
...
class HomeView(tk.Tk, View):
    def __init__(self,controller, root):
        ...
        gif_thread1 = GifThread(root, self.contentFrame,12, "../img/login_page.gif")
        gif_thread1.start() 
    ...
    def displayDashboard(self, contentFrame):
        ...
        tk.Label(contentFrameTwo, text = self.homeController.get_profit(), font =("Helvetica", 40, 'bold'), bg = '#179648', fg='#ffffff').place(x = 200, y = 80)
