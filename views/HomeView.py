...
class HomeView(tk.Tk, View):
    ...
    def displayManageProducts(self, contentFrame):
        ...
        # Treeview
        self.tree = self.homeController.showTreeView_ProductList(contentFrame, productFrame, searchBar.get(), sortDrop.get(), categoryDrop.get(), brandDrop.get())
    ...
    def displayNewOrder(self, contentFrame):
        ...
        self.tree = self.homeController.showTreeView_OrderProductList(contentFrame, productInput)
    ...
    def displayManageOrders(self, contentFrame):
        ...
        # Treeview
        self.tree = self.homeController.showTreeView_OrderList(contentFrame, orderFrame)
